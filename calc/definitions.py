...
class FunctionDefinition(Definition):
    def __init__(self, name, args, func,
                 precedence=None, display_name=None,
                 manual_eval=False, help_text=None):
        """
        Define a function.
...
class BinaryOperatorDefinition(Definition):
    ...
    def __init__(self, symbol, func, precedence, associativity, manual_eval=False, help_text=None):
        """
        Define a binary operator.

        :param symbol: Operator symbol (must be exactly 1 character)
        :param func: Function that implements the operator (should take 2 inputs)
...
class VariableDefinition(Definition):
    ...
    def __init__(self, name, value, display_name=None, help_text=None):
        """
        Defines a variable.
